...
{
    /// <summary>
    /// Quest 관련 데이터 테이블을 Addressables의 Table 그룹에 등록하는 에디터 설정 클래스입니다.
    /// </summary>
    /// <remarks>
    /// ConfigAddressableTableQuest.All 목록을 순회하며 각 테이블 에셋을 키/경로로 등록하고,
    /// 공통 라벨(ConfigAddressableLabel.Table)을 적용합니다.
    /// </remarks>
    public class SettingTableQuest : DefaultAddressable
    {
        /// <summary>
        /// 버튼에 표시되는 텍스트(기능 실행 제목)입니다.
        /// </summary>
        private const string Title = "Quest 테이블 추가하기";
        ...
        /// <summary>
        /// Quest 테이블 Addressables 등록 UI를 초기화합니다.
        /// </summary>
        /// <param name="addressableEditorWindow">버튼 크기 등 UI 정보를 참조할 에디터 윈도우입니다.</param>
        public SettingTableQuest(AddressableEditorQuest addressableEditorWindow)
        {
        ...
        /// <summary>
        /// Quest 관련 테이블 원본과 런타임 테이블 팩을 Addressables에 등록하고 저장합니다.
        /// </summary>
        /// <param name="ctx">
        ...
        /// - ConfigAddressableTableQuest.All에 정의된 테이블을 키/경로로 등록하고 공통 라벨을 부여합니다.
        /// </remarks>
        public void Setup(EditorSetupContext ctx = null)
        {
            ...
            // Quest 테이블 목록을 Addressables 엔트리로 등록
            foreach (var addressableAssetInfo in ConfigAddressableTableQuest.All)
            {
        ...
        /// <summary>
        /// Quest 개별 테이블 txt를 런타임 팩으로 생성하고 Addressables에 등록합니다.
        /// </summary>
        ...
        private void RegisterRuntimeTablePack(AddressableAssetSettings settings, AddressableAssetGroup group, EditorSetupContext ctx)
        {
            ...
            if (!built)
            {
                HelperLog.Warn("Quest 런타임 테이블 팩 생성에 실패했습니다. 개별 테이블 등록은 계속 진행합니다.", ctx);
                return;
            }
