...
{
    /// <summary>
    /// Quest 패키지 테이블 저장 후 Quest 런타임 테이블 pack을 재생성하는 Provider입니다.
    /// </summary>
    internal sealed class QuestTableEditorPackBuildProvider : TableEditorPackBuildProviderBase
    {
        /// <summary>
        /// Provider가 담당하는 패키지 표시 이름입니다.
        /// </summary>
        public override string PackageName => "Quest";
        ...
        /// </summary>
        protected override IReadOnlyList<AddressableAssetInfo> Tables => ConfigAddressableTableQuest.All;
    }
}
