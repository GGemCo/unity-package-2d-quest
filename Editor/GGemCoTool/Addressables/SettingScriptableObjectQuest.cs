...
namespace GGemCo2DQuestEditor
{
    ...
    /// </summary>
    /// <remarks>
    /// ConfigAddressableSettingQuest.NeedLoadInLoadingScene 목록을 기반으로 키/경로/라벨을 일괄 등록합니다.
    /// </remarks>
    public class SettingScriptableObjectQuest : DefaultAddressable
    {
        /// <summary>
        ...
        /// </summary>
        private readonly AddressableEditorQuest _addressableEditorQuest;

        /// <summary>
        /// 설정 ScriptableObject Addressables 등록 UI를 초기화합니다.
        /// </summary>
        /// <param name="addressableEditorQuestWindow">버튼 크기 등 UI 정보를 참조할 에디터 윈도우입니다.</param>
        public SettingScriptableObjectQuest(AddressableEditorQuest addressableEditorQuestWindow)
        {
            _addressableEditorQuest = addressableEditorQuestWindow;
        ...
        public void OnGUI()
        {
            ...
            if (GUILayout.Button(Title, GUILayout.Width(_addressableEditorQuest.buttonWidth), GUILayout.Height(_addressableEditorQuest.buttonHeight)))
            {
                try
                {
                    Setup();
        ...
        public void Setup(EditorSetupContext ctx = null)
        {
            ...
            foreach (var addressableAssetInfo in ConfigAddressableSettingQuest.NeedLoadInLoadingScene)
            {
